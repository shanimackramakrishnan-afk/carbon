...
df["family_size_encoded"] = encoder.fit_transform(df["family_size"])
df["batteries_encoded"] = encoder.fit_transform(df["batteries"])
...
clean_df.to_csv("AI_cleaned_household_dataset.csv", index=False)
